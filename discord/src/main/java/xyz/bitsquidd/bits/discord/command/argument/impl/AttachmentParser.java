...
public class AttachmentParser extends JdaArgumentParser<Message.Attachment> {
    public Class<Message.Attachment> type() { return Message.Attachment.class; }
    public OptionType optionType() { return OptionType.ATTACHMENT; }
    public Message.Attachment resolve(OptionMapping m, JdaCommandContext ctx) { return m.getAsAttachment(); }
}
